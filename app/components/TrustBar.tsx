        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6">
          {trustItems.map((item, i) => (
            <div key={i} className="flex items-center gap-3">
              ...
              <span className="flex items-center gap-1.5 text-[11px] tracking-[0.15em] text-gray font-syne font-bold uppercase">
          ...
          <a href="tel:7182272008" className="text-[11px] tracking-[0.15em] text-amber-dark font-syne font-bold uppercase hover:text-amber transition-colors">
            (718) 227-2008
          </a>
        </div>
      </div>
